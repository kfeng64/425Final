...
public class ArenaCameraController : MonoBehaviour
{
	...
	//   void Update()
	//   {
	//	distance = Vector3.Distance(p1.position, p2.position) + 5;
	//	midPoint = (p1.position + p2.position) / 2;
	...
	//	transform.position = new Vector3(midPoint.x, transform.position.y, -distance);

	//   }

	public static ArenaCameraController cFollow;
